...
from linebot.models import MessageEvent, TextMessage, TextSendMessage, ImageSendMessage, FollowEvent, UnfollowEvent, TemplateSendMessage, ButtonsTemplate
    ...
    for event in events:
        if isinstance(event, MessageEvent) and \
            ...
            if event.message.text == 'FSM':
                message: str = 'https://raw.githubusercontent.com/Jench2103/tw-stock-linebot/main/docs/images/fsm-graph.png'
